import Periodico from "../assets/images/periodico.jpeg"

const Footer = () => {
    return(
        <div className=" mt-20">
            <footer class="bg-black lg:grid lg:grid-cols-5 w-full">
                <div class="relative block h-32 lg:col-span-2 lg:h-full">
                    <img src={Periodico} alt="" class="absolute inset-0 h-full w-full object-cover"/>
                </div>
                ...
                <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
                    ...
                    <div>
                        ...
                        <a href="#" class="block text-2xl font-medium text-gray-900 hover:opacity-75 sm:text-3xl dark:text-white">
                            0123456789
                        </a>
                        </p>
